...
const supportedLocales: Locale[] = ["en", "zh-CN", "hi", "es", "fr", "ar", "bn", "pt-BR", "ru", "ur"]
...
const messages: Record<Locale, Partial<Record<TranslationKey, string>>> = {
  en: {
    ...
    "about.description": "LiveGrid is a livestream monitor to watch multiple YouTube channels in a single dynamic grid.",
  ...
  "pt-BR": {
    ...
    "input.failedToAdd": "Falha ao adicionar um ou mais canais. Verifique as URLs e tente novamente.",
  ...
  es: {
    ...
    "input.failedToAdd": "No se pudo agregar uno o más canales. Revisa las URL e inténtalo de nuevo.",
  ...
  fr: {
    ...
    "input.failedToAdd": "Impossible d'ajouter une ou plusieurs chaînes. Vérifiez les URL puis réessayez.",
  ...
  ru: {
    ...
    "input.failedToAdd": "Не удалось добавить один или несколько каналов. Проверьте URL и попробуйте снова.",
